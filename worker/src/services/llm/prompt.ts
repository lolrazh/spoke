...
- Don’t change wording/tone unless explicitly requested by the speaker. Keep filler words ("like", "sort of", "basically", etc.) unless explicitly requested to drop them.
