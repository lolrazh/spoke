...
describe('stripHallucinations', () => {
  ...
  it('should NOT remove the phrase from the middle of text', () => {
    ...
    const expected = 'I want to say thank you for watching! my presentation today';
    expect(stripHallucinations(input)).toBe(expected);
  });
  ...
  it('should preserve legitimate dictation that happens to end with the phrase', () => {
    const input = 'I really enjoyed making this video and I wanted to say thank you for watching!';
  ...
  it('should remove "Subtitles by the Amara.org community." from the end', () => {
    const input = 'This is my actual dictation Subtitles by the Amara.org community.';
    const expected = 'This is my actual dictation';
    expect(stripHallucinations(input)).toBe(expected);
  });
  ...
  it('should NOT remove Amara subtitle from the middle of text', () => {
    const input = 'Subtitles by the Amara.org community. are helpful for accessibility';
    const expected = 'Subtitles by the Amara.org community. are helpful for accessibility';
    expect(stripHallucinations(input)).toBe(expected);
  });
