...
const glyphForFamily = (family: string): React.ReactNode =>
  family === "cohere" ? <CohereGlyph /> : <OpenAiGlyph />;
                        ...
                        {modelInfos.map((info) => {
                          ...
                          return (
                            <button
                              ...
                              className={`onboarding-permission-row rounded-lg p-3 text-left transition-all duration-300 ${
                                selected
