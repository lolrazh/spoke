...
>(({ className, ...props }, ref) => (
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        // Thumb: rectangular with minimal rounded corners, clearly visible over glass track
        "pointer-events-none block h-3.5 w-3.5 rounded-sm bg-white/90 shadow-md ring-0 border border-white/30 transition-transform",
